<template>
  <q-page class="q-pa-md bg-grey-1">
    <q-form @submit="Save" autocomplete="off">
      <div class="text-subtitle1 text-bold">Crear Solución Aditiva</div>
      <q-separator/>
      <q-card flat class=" bg-grey-1">
        <q-card-section>
          <div class="row">
            <div class="col-md-4 col-lg-6 q-px-sm q-py-sm">
              <q-select @update:model-value="UpdateNom" dense outlined v-model="nomencladorSolucionAditivaId" option-label="name" option-value="name"
...
<script>
  ...
  export default {
    name: 'CreateMPSolucionesAditivas',
    data() {
      return {
